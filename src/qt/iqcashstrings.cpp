...
QT_TRANSLATE_NOOP("iqcash-core", ""
"Disable all IQcash specific functionality (Masternodes, PrivateSend, "
...
"transaction that are not equal 1000 IQ."),
QT_TRANSLATE_NOOP("iqcash-core", ""
...
QT_TRANSLATE_NOOP("iqcash-core", "%s - %d confirmations"),
QT_TRANSLATE_NOOP("iqcash-core", "(%d could be used only on mainnet)"),
QT_TRANSLATE_NOOP("iqcash-core", "(default: %s)"),
QT_TRANSLATE_NOOP("iqcash-core", "(default: %u)"),
QT_TRANSLATE_NOOP("iqcash-core", "(must be %d for mainnet)"),
QT_TRANSLATE_NOOP("iqcash-core", "-maxmempool must be at least %d MB"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Attempt to recover private keys from a corrupt wallet.dat on startup"),
QT_TRANSLATE_NOOP("iqcash-core", "Automatic backups disabled"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Can't mix: no compatible inputs found!"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Chain selection options:"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Connect to KeePassHttp on port <port> (default: %u)"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Copyright (C) 2014-%i The IQcash Core Developers"),
...
QT_TRANSLATE_NOOP("iqcash-core", "ERROR! Failed to create automatic backup"),
QT_TRANSLATE_NOOP("iqcash-core", "Enable publish hash block in <address>"),
QT_TRANSLATE_NOOP("iqcash-core", "Enable publish hash transaction (locked via InstantSend) in <address>"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Enable publish raw transaction (locked via InstantSend) in <address>"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Enable transaction replacement in the memory pool (default: %u)"),
QT_TRANSLATE_NOOP("iqcash-core", "Entries are full."),
QT_TRANSLATE_NOOP("iqcash-core", "Entry exceeds maximum size."),
...
QT_TRANSLATE_NOOP("iqcash-core", "Error loading %s: You can't disable HD on a already existing HD wallet"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Failed to create backup %s!"),
QT_TRANSLATE_NOOP("iqcash-core", "Failed to create backup, error: %s"),
QT_TRANSLATE_NOOP("iqcash-core", "Failed to delete backup, error: %s"),
QT_TRANSLATE_NOOP("iqcash-core", "Failed to listen on any port. Use -listen=0 if you want this."),
QT_TRANSLATE_NOOP("iqcash-core", "Failed to load fulfilled requests cache from"),
QT_TRANSLATE_NOOP("iqcash-core", "Failed to load governance cache from"),
QT_TRANSLATE_NOOP("iqcash-core", "Failed to load masternode cache from"),
QT_TRANSLATE_NOOP("iqcash-core", "Failed to load masternode payments cache from"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Imports blocks from external blk000??.dat file on startup"),
...
QT_TRANSLATE_NOOP("iqcash-core", "InstantSend options:"),
QT_TRANSLATE_NOOP("iqcash-core", "Insufficient funds."),
QT_TRANSLATE_NOOP("iqcash-core", "Invalid -onion address: '%s'"),
QT_TRANSLATE_NOOP("iqcash-core", "Invalid -proxy address: '%s'"),
QT_TRANSLATE_NOOP("iqcash-core", "Invalid amount for -fallbackfee=<amount>: '%s'"),
...
QT_TRANSLATE_NOOP("iqcash-core", "KeePassHttp id for the established association"),
QT_TRANSLATE_NOOP("iqcash-core", "KeePassHttp key for AES encrypted communication with KeePass"),
QT_TRANSLATE_NOOP("iqcash-core", "Keep N IQ anonymized (default: %u)"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Keypool ran out, please call keypoolrefill first"),
QT_TRANSLATE_NOOP("iqcash-core", "Last PrivateSend was too recent."),
QT_TRANSLATE_NOOP("iqcash-core", "Last successful PrivateSend action was too recent."),
...
QT_TRANSLATE_NOOP("iqcash-core", "Loading fulfilled requests cache..."),
QT_TRANSLATE_NOOP("iqcash-core", "Loading governance cache..."),
...
QT_TRANSLATE_NOOP("iqcash-core", "Make the wallet broadcast transactions"),
QT_TRANSLATE_NOOP("iqcash-core", "Masternode cache is empty, skipping payments and governance cache..."),
...
QT_TRANSLATE_NOOP("iqcash-core", "Minimum bytes per sigop in transactions we relay and mine (default: %u)"),
QT_TRANSLATE_NOOP("iqcash-core", "Missing input transaction information."),
QT_TRANSLATE_NOOP("iqcash-core", "Mixing in progress..."),
QT_TRANSLATE_NOOP("iqcash-core", "Mnemonic passphrase is too long, must be at most 256 characters"),
...
QT_TRANSLATE_NOOP("iqcash-core", "No errors detected."),
...
QT_TRANSLATE_NOOP("iqcash-core", "Not enough funds to anonymize."),
QT_TRANSLATE_NOOP("iqcash-core", "Not in the Masternode list."),
QT_TRANSLATE_NOOP("iqcash-core", "Number of automatic wallet backups (default: %u)"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Port: %d"),
...
QT_TRANSLATE_NOOP("iqcash-core", "PrivateSend is idle."),
QT_TRANSLATE_NOOP("iqcash-core", "PrivateSend options:"),
QT_TRANSLATE_NOOP("iqcash-core", "PrivateSend request complete:"),
QT_TRANSLATE_NOOP("iqcash-core", "PrivateSend request incomplete:"),
QT_TRANSLATE_NOOP("iqcash-core", "Prune cannot be configured with a negative value."),
QT_TRANSLATE_NOOP("iqcash-core", "Prune mode is incompatible with -txindex."),
QT_TRANSLATE_NOOP("iqcash-core", "Pruning blockstore..."),
QT_TRANSLATE_NOOP("iqcash-core", "RPC server options:"),
QT_TRANSLATE_NOOP("iqcash-core", "Rebuild chain state and block index from the blk*.dat files on disk"),
QT_TRANSLATE_NOOP("iqcash-core", "Rebuild chain state from the currently indexed blocks"),
QT_TRANSLATE_NOOP("iqcash-core", "Receive and display P2P network alerts (default: %u)"),
QT_TRANSLATE_NOOP("iqcash-core", "Reducing -maxconnections from %d to %d, because of system limitations."),
...
QT_TRANSLATE_NOOP("iqcash-core", "Rescan the block chain for missing wallet transactions on startup"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Send trace/debug info to console instead of debug.log file"),
QT_TRANSLATE_NOOP("iqcash-core", "Send trace/debug info to debug.log file (default: %u)"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Synchroning blockchain..."),
...
QT_TRANSLATE_NOOP("iqcash-core", "Synchronizing governance objects..."),
QT_TRANSLATE_NOOP("iqcash-core", "Synchronizing masternode payments..."),
QT_TRANSLATE_NOOP("iqcash-core", "Synchronizing masternodes..."),
QT_TRANSLATE_NOOP("iqcash-core", "The transaction amount is too small to pay the fee"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Too many %f denominations, removing."),
...
QT_TRANSLATE_NOOP("iqcash-core", "Unknown response."),
QT_TRANSLATE_NOOP("iqcash-core", "Unknown state: id = %u"),
QT_TRANSLATE_NOOP("iqcash-core", "Unsupported argument -benchmark ignored, use -debug=bench."),
QT_TRANSLATE_NOOP("iqcash-core", "Unsupported argument -debugnet ignored, use -debug=net."),
QT_TRANSLATE_NOOP("iqcash-core", "Unsupported argument -tor found, use -onion."),
QT_TRANSLATE_NOOP("iqcash-core", "Upgrade wallet to latest format on startup"),
QT_TRANSLATE_NOOP("iqcash-core", "Use KeePass 2 integration using KeePassHttp plugin (default: %u)"),
QT_TRANSLATE_NOOP("iqcash-core", "Use UPnP to map the listening port (default: %u)"),
QT_TRANSLATE_NOOP("iqcash-core", "Use the test chain"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Very low number of keys left: %d"),
...
QT_TRANSLATE_NOOP("iqcash-core", "Warning: unknown new rules activated (versionbit %i)"),
QT_TRANSLATE_NOOP("iqcash-core", "Wasn't able to create wallet backup folder %s!"),
QT_TRANSLATE_NOOP("iqcash-core", "Whether to operate in a blocks only mode (default: %u)"),
...
QT_TRANSLATE_NOOP("iqcash-core", "no mixing available."),
QT_TRANSLATE_NOOP("iqcash-core", "see debug.log for details."),
