    ...
    platformStyle(platformStyle)
{
    ...
    {
        progressBar->setStyleSheet("QProgressBar { background-color: #F8F8F8; border: 1px solid grey; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #7D145A, stop: 1 #911868); border-radius: 7px; margin: 0px; }");
    }
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About IQcash Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for IQcash Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the IQcash Core help message to get a list with possible IQcash Core command-line options"));
