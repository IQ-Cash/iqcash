...
const char * const BITCOIN_CONF_FILENAME = "iqcash.conf";
const char * const BITCOIN_PID_FILENAME = "iqcashd.pid";
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\IQcashCore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\IQcashCore
    // Mac: ~/Library/Application Support/IQcashCore
    // Unix: ~/.iqcashcore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "IQcashCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/IQcashCore";
#else
    // Unix
    return pathRet / ".iqcashcore";
#endif
#endif
}
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()){
        // Create empty iqcash.conf if it does not excist
