...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "IQcashNetwork") type = IQcashNetwork;
    if(strType == "IQcashNetworkVariable") type = IQcashNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == IQcashNetwork) s = "IQcashNetwork";
    if(type == IQcashNetworkVariable) s = "IQcashNetworkVariable";
